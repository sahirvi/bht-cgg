...
public class Raytracer implements Sampler {
	...
	public Color getColor(double x, double y) { // Raytracing Algorithmus
		...
		Color color = calculateRadiance(ray, scene, 4);
		return color;
	}
...
//	static Color calculateRadiance(Ray ray, Shape scene, int depth) {
//		if(depth == 0) {
//			return Color.black;
//		}
//		
...
//		if (scattered != null){
//			Color ea = Color.add(hit.material.emission(ray, hit), hit.material.albedo(ray, hit));
//			return Color.multiply(ea, calculateRadiance(scattered, scene, depth-1));
//		}else {
